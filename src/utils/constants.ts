export const OPENAI_API_DEFAULT_MODEL = 'gpt-3.5-turbo';
export const OPENAI_API_DEFAULT_TEMPERATURE = 0.1;
...
export const RESPONSE_GENERATED_MESSAGE = 'Response has been generated';
export const TELEGRAM_INITIAL_RESPONSE_MESSAGE = 'Wait a second..';
